...
@__dt_filename = internal unnamed_addr constant [8 x i8] c"test4.c\00"
@__dt_pos = common global %struct.__dt_position zeroinitializer
@0 = private unnamed_addr constant [28 x i8] c"%lld\09%lld\09%lld\09%s\09%s\09%u\09%u\0A\00", align 1
@__dt_loopcounter0 = internal global i32 0, align 4
@__dt_loopcounter020 = internal global i32 0, align 4
@__dt_loopcounter021 = internal global i32 0, align 4
@__dt_loopcounter022 = internal global i32 0, align 4
@__dt_loopcounter023 = internal global i32 0, align 4
@__dt_loopcounter024 = internal global i32 0, align 4
@__dt_loopcounter025 = internal global i32 0, align 4
@__dt_loopcounter026 = internal global i32 0, align 4
@__dt_loopcounter027 = internal global i32 0, align 4
@__dt_loopcounter028 = internal global i32 0, align 4
...
while.body:                                       ; preds = %while.body, %if.then.i, %while.body.preheader
  ...
  %8 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([28 x i8]* @0, i64 0, i64 0), i64 %add, i64 %sub, i64 %sub2, i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3)), !dbg !432
  %9 = load i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 1), align 8, !dbg !434, !tbaa !399
  store i64 %9, i64* getelementptr inbounds ([3 x i64]* @tempvalues, i64 0, i64 1), align 8, !dbg !434, !tbaa !399
  %10 = load i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 2), align 16, !dbg !435, !tbaa !399
  store i64 %10, i64* getelementptr inbounds ([3 x i64]* @tempvalues, i64 0, i64 2), align 16, !dbg !435, !tbaa !399
...
entry:
  ...
  %.pre = load i32* @__dt_loopcounter0, align 4, !dbg !455
  br label %for.cond5.preheader, !dbg !453

for.cond5.preheader:                              ; preds = %for.inc11, %entry
  %1 = phi i32 [ %.pre, %entry ], [ %18, %for.inc11 ]
  %indvars.iv126 = phi i64 [ 0, %entry ], [ %indvars.iv.next127, %for.inc11 ]
  %2 = add nsw i32 %1, 1, !dbg !455
  store i32 %2, i32* @__dt_loopcounter0, align 4, !dbg !455
  %3 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !455
  %4 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !455
  store volatile i32 126, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !455
  %5 = load volatile i32* @__dt_loopcounter0, align 4, !dbg !455
  store i32 %5, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !455
  br label %for.body8, !dbg !455

for.cond14.preheader:                             ; preds = %for.inc11
  %.pre130 = load i32* @__dt_loopcounter021, align 4, !dbg !457
  br label %for.body17, !dbg !459

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %indvars.iv120 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next121, %for.body8 ]
  %6 = load i32* @__dt_loopcounter020, align 4, !dbg !460
  %7 = add nsw i32 %6, 1, !dbg !460
  store i32 %7, i32* @__dt_loopcounter020, align 4, !dbg !460
  %8 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !460
  %9 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !460
  store volatile i32 126, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !460
  %10 = load volatile i32* @__dt_loopcounter020, align 4, !dbg !460
  store i32 %10, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !460
  %11 = shl i64 %indvars.iv120, 4, !dbg !460
  %12 = add nsw i64 %11, %indvars.iv126, !dbg !460
  %arrayidx = getelementptr inbounds i32* %0, i64 %12, !dbg !460
  %13 = load i32* %arrayidx, align 4, !dbg !460, !tbaa !431
  %inc = add nsw i32 %13, 1, !dbg !460
  store i32 %inc, i32* %arrayidx, align 4, !dbg !460, !tbaa !431
  %indvars.iv.next121 = add i64 %indvars.iv120, 1, !dbg !455
  %14 = load i32* @__dt_loopcounter0, align 4, !dbg !455
  %15 = add nsw i32 %14, 1, !dbg !455
  store i32 %15, i32* @__dt_loopcounter0, align 4, !dbg !455
  %16 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !455
  %17 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !455
  store volatile i32 126, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !455
  %18 = load volatile i32* @__dt_loopcounter0, align 4, !dbg !455
  store i32 %18, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !455
  %lftr.wideiv124 = trunc i64 %indvars.iv.next121 to i32, !dbg !455
  %exitcond125 = icmp eq i32 %lftr.wideiv124, 131072, !dbg !455
  br i1 %exitcond125, label %for.inc11, label %for.body8, !dbg !455

for.inc11:                                        ; preds = %for.body8
  %indvars.iv.next127 = add i64 %indvars.iv126, 1, !dbg !453
  call void @llvm.dbg.value(metadata !412, i64 0, metadata !35), !dbg !455
  %lftr.wideiv128 = trunc i64 %indvars.iv.next127 to i32, !dbg !453
  %exitcond129 = icmp eq i32 %lftr.wideiv128, 16, !dbg !453
  br i1 %exitcond129, label %for.cond14.preheader, label %for.cond5.preheader, !dbg !453

for.cond24.preheader:                             ; preds = %for.body17
  call void @llvm.dbg.value(metadata !412, i64 0, metadata !35), !dbg !462
  %.pre131 = load i32* @__dt_loopcounter022, align 4, !dbg !462
  br label %for.cond28.preheader, !dbg !465

for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %19 = phi i32 [ %.pre130, %for.cond14.preheader ], [ %23, %for.body17 ], !dbg !457
  %indvars.iv116 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next117, %for.body17 ]
  %20 = add nsw i32 %19, 1, !dbg !457
  store i32 %20, i32* @__dt_loopcounter021, align 4, !dbg !457
  %21 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !457
  %22 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !457
  store volatile i32 135, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !457
  %23 = load volatile i32* @__dt_loopcounter021, align 4, !dbg !457
  store i32 %23, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !457
  %arrayidx19 = getelementptr inbounds i32* %0, i64 %indvars.iv116, !dbg !457
  %24 = load i32* %arrayidx19, align 4, !dbg !457, !tbaa !431
  %inc20 = add nsw i32 %24, 1, !dbg !457
  store i32 %inc20, i32* %arrayidx19, align 4, !dbg !457, !tbaa !431
  %indvars.iv.next117 = add i64 %indvars.iv116, 1, !dbg !459
  %lftr.wideiv118 = trunc i64 %indvars.iv.next117 to i32, !dbg !459
  %exitcond119 = icmp eq i32 %lftr.wideiv118, 2097152, !dbg !459
  br i1 %exitcond119, label %for.cond24.preheader, label %for.body17, !dbg !459

for.cond28.preheader:                             ; preds = %for.inc40, %for.cond24.preheader
  %25 = phi i32 [ %.pre131, %for.cond24.preheader ], [ %42, %for.inc40 ]
  %indvars.iv112 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next113, %for.inc40 ]
  %26 = add nsw i32 %25, 1, !dbg !462
  store i32 %26, i32* @__dt_loopcounter022, align 4, !dbg !462
  %27 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !462
  %28 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !462
  store volatile i32 140, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !462
  %29 = load volatile i32* @__dt_loopcounter022, align 4, !dbg !462
  store i32 %29, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !462
  br label %for.body31, !dbg !462

for.cond43.preheader:                             ; preds = %for.inc40
  %.pre132 = load i32* @__dt_loopcounter024, align 4, !dbg !466
  br label %for.body46, !dbg !468

for.body31:                                       ; preds = %for.body31, %for.cond28.preheader
  %indvars.iv106 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next107, %for.body31 ]
  %30 = load i32* @__dt_loopcounter023, align 4, !dbg !469
  %31 = add nsw i32 %30, 1, !dbg !469
  store i32 %31, i32* @__dt_loopcounter023, align 4, !dbg !469
  %32 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !469
  %33 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !469
  store volatile i32 140, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !469
  %34 = load volatile i32* @__dt_loopcounter023, align 4, !dbg !469
  store i32 %34, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !469
  %35 = shl i64 %indvars.iv106, 4, !dbg !469
  %36 = add nsw i64 %35, %indvars.iv112, !dbg !469
  %arrayidx35 = getelementptr inbounds i32* %0, i64 %36, !dbg !469
  %37 = load i32* %arrayidx35, align 4, !dbg !469, !tbaa !431
  %inc36 = add nsw i32 %37, 1, !dbg !469
  store i32 %inc36, i32* %arrayidx35, align 4, !dbg !469, !tbaa !431
  %indvars.iv.next107 = add i64 %indvars.iv106, 1, !dbg !462
  %38 = load i32* @__dt_loopcounter022, align 4, !dbg !462
  %39 = add nsw i32 %38, 1, !dbg !462
  store i32 %39, i32* @__dt_loopcounter022, align 4, !dbg !462
  %40 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !462
  %41 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !462
  store volatile i32 140, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !462
  %42 = load volatile i32* @__dt_loopcounter022, align 4, !dbg !462
  store i32 %42, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !462
  %lftr.wideiv110 = trunc i64 %indvars.iv.next107 to i32, !dbg !462
  %exitcond111 = icmp eq i32 %lftr.wideiv110, 131072, !dbg !462
  br i1 %exitcond111, label %for.inc40, label %for.body31, !dbg !462

for.inc40:                                        ; preds = %for.body31
  %indvars.iv.next113 = add i64 %indvars.iv112, 1, !dbg !465
  call void @llvm.dbg.value(metadata !412, i64 0, metadata !35), !dbg !462
  %lftr.wideiv114 = trunc i64 %indvars.iv.next113 to i32, !dbg !465
  %exitcond115 = icmp eq i32 %lftr.wideiv114, 16, !dbg !465
  br i1 %exitcond115, label %for.cond43.preheader, label %for.cond28.preheader, !dbg !465

for.cond53.preheader:                             ; preds = %for.body46
  call void @llvm.dbg.value(metadata !412, i64 0, metadata !35), !dbg !470
  %.pre133 = load i32* @__dt_loopcounter025, align 4, !dbg !470
  br label %for.cond57.preheader, !dbg !473

for.body46:                                       ; preds = %for.body46, %for.cond43.preheader
  %43 = phi i32 [ %.pre132, %for.cond43.preheader ], [ %47, %for.body46 ], !dbg !466
  %indvars.iv102 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next103, %for.body46 ]
  %44 = add nsw i32 %43, 1, !dbg !466
  store i32 %44, i32* @__dt_loopcounter024, align 4, !dbg !466
  %45 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !466
  %46 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !466
  store volatile i32 144, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !466
  %47 = load volatile i32* @__dt_loopcounter024, align 4, !dbg !466
  store i32 %47, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !466
  %arrayidx48 = getelementptr inbounds i32* %0, i64 %indvars.iv102, !dbg !466
  %48 = load i32* %arrayidx48, align 4, !dbg !466, !tbaa !431
  %inc49 = add nsw i32 %48, 1, !dbg !466
  store i32 %inc49, i32* %arrayidx48, align 4, !dbg !466, !tbaa !431
  %indvars.iv.next103 = add i64 %indvars.iv102, 1, !dbg !468
  %lftr.wideiv104 = trunc i64 %indvars.iv.next103 to i32, !dbg !468
  %exitcond105 = icmp eq i32 %lftr.wideiv104, 2097152, !dbg !468
  br i1 %exitcond105, label %for.cond53.preheader, label %for.body46, !dbg !468

for.cond57.preheader:                             ; preds = %for.inc69, %for.cond53.preheader
  %49 = phi i32 [ %.pre133, %for.cond53.preheader ], [ %66, %for.inc69 ]
  %indvars.iv98 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next99, %for.inc69 ]
  %50 = add nsw i32 %49, 1, !dbg !470
  store i32 %50, i32* @__dt_loopcounter025, align 4, !dbg !470
  %51 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !470
  %52 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !470
  store volatile i32 149, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !470
  %53 = load volatile i32* @__dt_loopcounter025, align 4, !dbg !470
  store i32 %53, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !470
  br label %for.body60, !dbg !470

for.cond72.preheader:                             ; preds = %for.inc69
  %.pre134 = load i32* @__dt_loopcounter027, align 4, !dbg !474
  br label %for.body75, !dbg !476

for.body60:                                       ; preds = %for.body60, %for.cond57.preheader
  %indvars.iv92 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next93, %for.body60 ]
  %54 = load i32* @__dt_loopcounter026, align 4, !dbg !477
  %55 = add nsw i32 %54, 1, !dbg !477
  store i32 %55, i32* @__dt_loopcounter026, align 4, !dbg !477
  %56 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !477
  %57 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !477
  store volatile i32 149, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !477
  %58 = load volatile i32* @__dt_loopcounter026, align 4, !dbg !477
  store i32 %58, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !477
  %59 = shl i64 %indvars.iv92, 4, !dbg !477
  %60 = add nsw i64 %59, %indvars.iv98, !dbg !477
  %arrayidx64 = getelementptr inbounds i32* %0, i64 %60, !dbg !477
  %61 = load i32* %arrayidx64, align 4, !dbg !477, !tbaa !431
  %inc65 = add nsw i32 %61, 1, !dbg !477
  store i32 %inc65, i32* %arrayidx64, align 4, !dbg !477, !tbaa !431
  %indvars.iv.next93 = add i64 %indvars.iv92, 1, !dbg !470
  %62 = load i32* @__dt_loopcounter025, align 4, !dbg !470
  %63 = add nsw i32 %62, 1, !dbg !470
  store i32 %63, i32* @__dt_loopcounter025, align 4, !dbg !470
  %64 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !470
  %65 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !470
  store volatile i32 149, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !470
  %66 = load volatile i32* @__dt_loopcounter025, align 4, !dbg !470
  store i32 %66, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !470
  %lftr.wideiv96 = trunc i64 %indvars.iv.next93 to i32, !dbg !470
  %exitcond97 = icmp eq i32 %lftr.wideiv96, 131072, !dbg !470
  br i1 %exitcond97, label %for.inc69, label %for.body60, !dbg !470

for.inc69:                                        ; preds = %for.body60
  %indvars.iv.next99 = add i64 %indvars.iv98, 1, !dbg !473
  call void @llvm.dbg.value(metadata !412, i64 0, metadata !35), !dbg !470
  %lftr.wideiv100 = trunc i64 %indvars.iv.next99 to i32, !dbg !473
  %exitcond101 = icmp eq i32 %lftr.wideiv100, 16, !dbg !473
  br i1 %exitcond101, label %for.cond72.preheader, label %for.cond57.preheader, !dbg !473

for.body75:                                       ; preds = %for.body75, %for.cond72.preheader
  %67 = phi i32 [ %.pre134, %for.cond72.preheader ], [ %71, %for.body75 ], !dbg !474
  %indvars.iv = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next, %for.body75 ]
  %68 = add nsw i32 %67, 1, !dbg !474
  store i32 %68, i32* @__dt_loopcounter027, align 4, !dbg !474
  %69 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !474
  %70 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !474
  store volatile i32 153, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !474
  %71 = load volatile i32* @__dt_loopcounter027, align 4, !dbg !474
  store i32 %71, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !474
  %arrayidx77 = getelementptr inbounds i32* %0, i64 %indvars.iv, !dbg !474
  %72 = load i32* %arrayidx77, align 4, !dbg !474, !tbaa !431
  %inc78 = add nsw i32 %72, 1, !dbg !474
  store i32 %inc78, i32* %arrayidx77, align 4, !dbg !474, !tbaa !431
  %indvars.iv.next = add i64 %indvars.iv, 1, !dbg !476
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !476
  %exitcond = icmp eq i32 %lftr.wideiv, 2097152, !dbg !476
  br i1 %exitcond, label %for.end81, label %for.body75, !dbg !476
...
for.end81:                                        ; preds = %for.body75
  ...
  call void @llvm.dbg.value(metadata !{i64* %Thread}, i64 0, metadata !54), !dbg !478
  call void @llvm.dbg.value(metadata !{i64* %Thread}, i64 0, metadata !54), !dbg !478
  %73 = load i64* %Thread, align 8, !dbg !478, !tbaa !419
  %call82 = call i32 @pthread_cancel(i64 %73) nounwind, !dbg !478
  ret i32 0, !dbg !479
}
...
if.then5:                                         ; preds = %if.end
  %puts44 = call i32 @puts(i8* getelementptr inbounds ([19 x i8]* @str16, i64 0, i64 0)), !dbg !489
...
if.then10:                                        ; preds = %if.end7
  %puts45 = call i32 @puts(i8* getelementptr inbounds ([23 x i8]* @str17, i64 0, i64 0)), !dbg !494
...
if.then15:                                        ; preds = %if.end12
  %puts46 = call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str18, i64 0, i64 0)), !dbg !498
...
if.then22:                                        ; preds = %if.end17
  %puts47 = call i32 @puts(i8* getelementptr inbounds ([19 x i8]* @str19, i64 0, i64 0)), !dbg !505
...
for.cond:                                         ; preds = %for.inc, %if.end24
  ...
  %5 = trunc i64 %indvars.iv to i32, !dbg !512
  %cmp27 = icmp slt i32 %5, 3, !dbg !512
  br i1 %cmp27, label %for.body, label %for.end, !dbg !512

for.body:                                         ; preds = %for.cond
  %6 = load i32* @__dt_loopcounter028, align 4, !dbg !514
  %7 = add nsw i32 %6, 1, !dbg !514
  store i32 %7, i32* @__dt_loopcounter028, align 4, !dbg !514
  %8 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 0, i64 0), i8* getelementptr inbounds ([53 x i8]* @__dt_dirname, i64 0, i64 0)), !dbg !514
  %9 = call i8* @strcpy(i8* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 1, i64 0), i8* getelementptr inbounds ([8 x i8]* @__dt_filename, i64 0, i64 0)), !dbg !514
  store volatile i32 205, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 2), align 4, !dbg !514
  %10 = load volatile i32* @__dt_loopcounter028, align 4, !dbg !514
  store i32 %10, i32* getelementptr inbounds (%struct.__dt_position* @__dt_pos, i64 0, i32 3), align 4, !dbg !514
  %11 = load i32* @eventset, align 4, !dbg !514, !tbaa !431
  %arrayidx = getelementptr inbounds [3 x i32]* @events, i64 0, i64 %indvars.iv, !dbg !514
  %12 = load i32* %arrayidx, align 4, !dbg !514, !tbaa !431
  %call28 = call i32 @PAPI_add_event(i32 %11, i32 %12) nounwind, !dbg !514
...
for.end:                                          ; preds = %for.cond
  %call33 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([10 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !521
  ...
  %13 = load i32* @eventset, align 4, !dbg !523, !tbaa !431
  %call35 = call i32 @PAPI_start(i32 %13) nounwind, !dbg !523
  %call36 = call i32 @test(), !dbg !524
  %14 = load i32* @eventset, align 4, !dbg !525, !tbaa !431
  %call37 = call i32 @PAPI_stop(i32 %14, i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 0)) nounwind, !dbg !525
  ...
  %15 = load %struct._IO_FILE** @gnuplotfile, align 8, !dbg !527, !tbaa !433
  %call39 = call i32 @fclose(%struct._IO_FILE* %15) nounwind, !dbg !527
  ...
  %16 = load i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 0), align 16, !dbg !529, !tbaa !399
  %call41 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str12, i64 0, i64 0), i64 %16) nounwind, !dbg !529
  %17 = load i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 1), align 8, !dbg !530, !tbaa !399
  %call42 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([37 x i8]* @.str13, i64 0, i64 0), i64 %17) nounwind, !dbg !530
  %18 = load i64* getelementptr inbounds ([3 x i64]* @values, i64 0, i64 2), align 16, !dbg !531, !tbaa !399
  %call43 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str14, i64 0, i64 0), i64 %18) nounwind, !dbg !531
  ret i32 0, !dbg !532
}
...
!0 = metadata !{i32 720913, i32 0, i32 12, metadata !"test4.c", metadata !"/home/kula85/Research/delay-thread/testCacheMissTool", metadata !"clang version 3.1 (trunk 144408)", i1 true, i1 true, metadata !"", i32 0, metadata !1, metadata !8, metadata !17, metadata !333} ; [ DW_TAG_compile_unit ]
...
!11 = metadata !{i32 720937, metadata !"test4.c", metadata !"/home/kula85/Research/delay-thread/testCacheMissTool", null} ; [ DW_TAG_file_type ]
...
!30 = metadata !{i32 720942, i32 0, metadata !11, metadata !"test", metadata !"test", metadata !"", metadata !11, i32 104, metadata !31, i1 false, i1 true, i32 0, i32 0, i32 0, i32 0, i1 true, i32 ()* @test, null, null, metadata !33} ; [ DW_TAG_subprogram ]
...
!35 = metadata !{i32 721152, metadata !36, metadata !"i", metadata !11, i32 105, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!36 = metadata !{i32 720907, metadata !30, i32 104, i32 12, metadata !11, i32 2} ; [ DW_TAG_lexical_block ]
!37 = metadata !{i32 721152, metadata !36, metadata !"j", metadata !11, i32 105, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!38 = metadata !{i32 721152, metadata !36, metadata !"numInt", metadata !11, i32 106, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!39 = metadata !{i32 721152, metadata !36, metadata !"numCachelineUsed", metadata !11, i32 107, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!40 = metadata !{i32 721152, metadata !36, metadata !"a", metadata !11, i32 108, metadata !41, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!41 = metadata !{i32 720911, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !14} ; [ DW_TAG_pointer_type ]
!42 = metadata !{i32 721152, metadata !36, metadata !"attr", metadata !11, i32 116, metadata !43, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!54 = metadata !{i32 721152, metadata !36, metadata !"Thread", metadata !11, i32 117, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!57 = metadata !{i32 720942, i32 0, metadata !11, metadata !"main", metadata !"main", metadata !"", metadata !11, i32 162, metadata !58, i1 false, i1 true, i32 0, i32 0, i32 0, i32 256, i1 true, i32 (i32, i8**)* @main, null, null, metadata !62} ; [ DW_TAG_subprogram ]
...
!64 = metadata !{i32 721153, metadata !57, metadata !"argc", metadata !11, i32 16777377, metadata !14, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!65 = metadata !{i32 721153, metadata !57, metadata !"argv", metadata !11, i32 33554593, metadata !60, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!66 = metadata !{i32 721152, metadata !67, metadata !"i", metadata !11, i32 163, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!67 = metadata !{i32 720907, metadata !57, i32 162, i32 1, metadata !11, i32 13} ; [ DW_TAG_lexical_block ]
!68 = metadata !{i32 721152, metadata !67, metadata !"j", metadata !11, i32 163, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 721152, metadata !67, metadata !"s", metadata !11, i32 166, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!70 = metadata !{i32 721152, metadata !67, metadata !"e", metadata !11, i32 167, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!71 = metadata !{i32 721152, metadata !67, metadata !"retval", metadata !11, i32 168, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 721152, metadata !67, metadata !"eventcode", metadata !11, i32 169, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!73 = metadata !{i32 721152, metadata !67, metadata !"opt", metadata !11, i32 170, metadata !74, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!427 = metadata !{i32 99, i32 5, metadata !428, null}
...
!434 = metadata !{i32 97, i32 5, metadata !428, null}
!435 = metadata !{i32 98, i32 5, metadata !428, null}
...
!444 = metadata !{i32 110, i32 3, metadata !36, null}
!445 = metadata !{i32 131072}
!446 = metadata !{i32 112, i32 3, metadata !36, null}
!447 = metadata !{i32 114, i32 14, metadata !36, null}
!448 = metadata !{i32 116, i32 18, metadata !36, null}
!449 = metadata !{i32 117, i32 13, metadata !36, null}
!450 = metadata !{i32 119, i32 3, metadata !36, null}
!451 = metadata !{i32 120, i32 3, metadata !36, null}
!452 = metadata !{i32 122, i32 3, metadata !36, null}
!453 = metadata !{i32 125, i32 7, metadata !454, null}
!454 = metadata !{i32 720907, metadata !36, i32 125, i32 3, metadata !11, i32 3} ; [ DW_TAG_lexical_block ]
!455 = metadata !{i32 126, i32 9, metadata !456, null}
!456 = metadata !{i32 720907, metadata !454, i32 126, i32 5, metadata !11, i32 4} ; [ DW_TAG_lexical_block ]
!457 = metadata !{i32 136, i32 6, metadata !458, null}
!458 = metadata !{i32 720907, metadata !36, i32 135, i32 3, metadata !11, i32 6} ; [ DW_TAG_lexical_block ]
!459 = metadata !{i32 135, i32 7, metadata !458, null}
!460 = metadata !{i32 131, i32 7, metadata !461, null}
!461 = metadata !{i32 720907, metadata !456, i32 126, i32 40, metadata !11, i32 5} ; [ DW_TAG_lexical_block ]
!462 = metadata !{i32 140, i32 9, metadata !463, null}
!463 = metadata !{i32 720907, metadata !464, i32 140, i32 5, metadata !11, i32 8} ; [ DW_TAG_lexical_block ]
!464 = metadata !{i32 720907, metadata !36, i32 139, i32 3, metadata !11, i32 7} ; [ DW_TAG_lexical_block ]
!465 = metadata !{i32 139, i32 7, metadata !464, null}
!466 = metadata !{i32 145, i32 6, metadata !467, null}
!467 = metadata !{i32 720907, metadata !36, i32 144, i32 3, metadata !11, i32 9} ; [ DW_TAG_lexical_block ]
!468 = metadata !{i32 144, i32 7, metadata !467, null}
!469 = metadata !{i32 141, i32 8, metadata !463, null}
!470 = metadata !{i32 149, i32 9, metadata !471, null}
!471 = metadata !{i32 720907, metadata !472, i32 149, i32 5, metadata !11, i32 11} ; [ DW_TAG_lexical_block ]
!472 = metadata !{i32 720907, metadata !36, i32 148, i32 3, metadata !11, i32 10} ; [ DW_TAG_lexical_block ]
!473 = metadata !{i32 148, i32 7, metadata !472, null}
!474 = metadata !{i32 154, i32 6, metadata !475, null}
!475 = metadata !{i32 720907, metadata !36, i32 153, i32 3, metadata !11, i32 12} ; [ DW_TAG_lexical_block ]
!476 = metadata !{i32 153, i32 7, metadata !475, null}
!477 = metadata !{i32 150, i32 8, metadata !471, null}
!478 = metadata !{i32 156, i32 3, metadata !36, null}
!479 = metadata !{i32 158, i32 3, metadata !36, null}
!480 = metadata !{i32 161, i32 15, metadata !57, null}
!481 = metadata !{i32 161, i32 27, metadata !57, null}
!482 = metadata !{i32 169, i32 7, metadata !67, null}
!483 = metadata !{i32 170, i32 17, metadata !67, null}
!484 = metadata !{i32 172, i32 26, metadata !67, null}
!485 = metadata !{i32 173, i32 5, metadata !486, null}
!486 = metadata !{i32 720907, metadata !67, i32 172, i32 62, metadata !11, i32 14} ; [ DW_TAG_lexical_block ]
!487 = metadata !{i32 174, i32 5, metadata !486, null}
!488 = metadata !{i32 177, i32 7, metadata !67, null}
!489 = metadata !{i32 178, i32 5, metadata !490, null}
!490 = metadata !{i32 720907, metadata !67, i32 177, i32 50, metadata !11, i32 15} ; [ DW_TAG_lexical_block ]
!491 = metadata !{i32 179, i32 5, metadata !490, null}
!492 = metadata !{i32 182, i32 3, metadata !67, null}
!493 = metadata !{i32 183, i32 6, metadata !67, null}
!494 = metadata !{i32 184, i32 5, metadata !495, null}
!495 = metadata !{i32 720907, metadata !67, i32 183, i32 49, metadata !11, i32 16} ; [ DW_TAG_lexical_block ]
!496 = metadata !{i32 185, i32 5, metadata !495, null}
!497 = metadata !{i32 188, i32 19, metadata !67, null}
!498 = metadata !{i32 189, i32 5, metadata !499, null}
!499 = metadata !{i32 720907, metadata !67, i32 188, i32 80, metadata !11, i32 17} ; [ DW_TAG_lexical_block ]
!500 = metadata !{i32 190, i32 5, metadata !499, null}
!501 = metadata !{i32 193, i32 3, metadata !67, null}
!502 = metadata !{i32 194, i32 3, metadata !67, null}
!503 = metadata !{i32 195, i32 3, metadata !67, null}
!504 = metadata !{i32 196, i32 19, metadata !67, null}
!505 = metadata !{i32 197, i32 5, metadata !506, null}
!506 = metadata !{i32 720907, metadata !67, i32 196, i32 69, metadata !11, i32 18} ; [ DW_TAG_lexical_block ]
!507 = metadata !{i32 198, i32 5, metadata !506, null}
!508 = metadata !{i32 201, i32 3, metadata !67, null}
!509 = metadata !{i32 202, i32 3, metadata !67, null}
!510 = metadata !{i32 203, i32 3, metadata !67, null}
!511 = metadata !{i32 204, i32 3, metadata !67, null}
!512 = metadata !{i32 205, i32 7, metadata !513, null}
!513 = metadata !{i32 720907, metadata !67, i32 205, i32 3, metadata !11, i32 19} ; [ DW_TAG_lexical_block ]
!514 = metadata !{i32 206, i32 14, metadata !515, null}
!515 = metadata !{i32 720907, metadata !513, i32 205, i32 20, metadata !11, i32 20} ; [ DW_TAG_lexical_block ]
!516 = metadata !{i32 207, i32 5, metadata !515, null}
!517 = metadata !{i32 208, i32 7, metadata !518, null}
!518 = metadata !{i32 720907, metadata !515, i32 207, i32 26, metadata !11, i32 21} ; [ DW_TAG_lexical_block ]
!519 = metadata !{i32 209, i32 7, metadata !518, null}
!520 = metadata !{i32 205, i32 15, metadata !513, null}
!521 = metadata !{i32 216, i32 17, metadata !67, null}
!522 = metadata !{i32 218, i32 7, metadata !67, null}
!523 = metadata !{i32 219, i32 3, metadata !67, null}
!524 = metadata !{i32 220, i32 3, metadata !67, null}
!525 = metadata !{i32 221, i32 3, metadata !67, null}
!526 = metadata !{i32 222, i32 7, metadata !67, null}
!527 = metadata !{i32 223, i32 3, metadata !67, null}
!528 = metadata !{i32 227, i32 3, metadata !67, null}
!529 = metadata !{i32 228, i32 3, metadata !67, null}
!530 = metadata !{i32 229, i32 3, metadata !67, null}
!531 = metadata !{i32 230, i32 3, metadata !67, null}
!532 = metadata !{i32 232, i32 3, metadata !67, null}
