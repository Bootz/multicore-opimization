...
//===----------------------------------------------------------------------===//
//
// LoopCountInsertion - Pass to add loop profiling counter to know
// which iteration we are in. This pass also generate a file 
// runs efficiently when queued next to other BasicBlockPass's.
// which contains info about which counter is for which loop
// (line no is for cmp inst)
//
Pass *createLoopCountInsertionPass();
